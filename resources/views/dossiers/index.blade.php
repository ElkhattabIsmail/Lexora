                    ...
                    <form method="GET" action="{{ route('dossiers.index') }}" class="space-y-3">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            @if ($search || $statut || $avocatId)
                                <a href="{{ route('dossiers.index') }}" class="px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-600 text-sm font-medium rounded-lg transition-colors">
                                    Réinitialiser
                                </a>
                            @endif
                    ...
                    @forelse ($dossiers as $dossier)
                        <div class="p-4 hover:bg-slate-50 transition-colors">
                            ...
                            <div class="flex items-center gap-1 mt-3">
                                <a href="{{ route('dossiers.show', $dossier) }}" class="text-slate-400 hover:text-brand-DEFAULT transition-colors p-1">
                                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                                </a>
                                <a href="{{ route('dossiers.edit', $dossier) }}" class="text-slate-400 hover:text-amber-500 transition-colors p-1">
                                    <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" /></svg>
                                </a>
                                <form method="POST" action="{{ route('dossiers.destroy', $dossier) }}" onsubmit="return confirm('Supprimer ce dossier ?')">
                                    @csrf @method('DELETE')
