                ...
                <form action="{{ route('dossiers.update', $dossier) }}" method="POST">
                    ...
                    <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div x-data="searchableSelect({
                                ...
                                selected: '{{ old('client_id', $dossier->client_id) }}',
                            ...
                            <div class="mt-1 relative">
                                <input
                                    ...
                                    class="block w-full rounded-lg border-slate-300 shadow-sm focus:border-brand-DEFAULT focus:ring focus:ring-brand-DEFAULT/20 pr-8"
                                    autocomplete="off"
                                >
                        ...
                        <div x-data="searchableSelect({
                                ...
                                selected: '{{ old('avocat_id', $dossier->avocat_id) }}',
